...
window.addEventListener('error', function(e){
  ...
  div.style.cssText = 'position:fixed;top:0;left:0;right:0;background:#FF4B6E;color:#fff;padding:12px 16px;font-size:13px;z-index:99999;font-family:monospace;white-space:pre-wrap;max-height:200px;overflow:auto';
  div.textContent = '🔴 JS错误: ' + e.message + '\n文件:' + e.filename + '\n行:' + e.lineno + ' 列:' + e.colno;
