...
// ---- 配置区（老板可修改） ----
const CS_CONFIG = {
  groqKey: '',            // 填入 Groq API Key 后启用真实 AI（留空 = 本地知识库模式）
